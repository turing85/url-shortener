...
class ShortenedUrlEndpointTest {
  ...
  void postWithUrlAndShortened() throws MalformedURLException {
    ...
    RestAssured
        ...
        .then().assertThat()
            ...
            .body("url", is(expectedUrl.toString())).body("shortened", is(expectedShortened));
    // @formatter:on
  }
  ...
  void postWithUrl() throws MalformedURLException {
    ...
    final ValidatableResponse options = RestAssured
        ...
        .then().assertThat()
            ...
            .body("shortened", matchesPattern("[a-zA-Z0-9]{%d}"
                .formatted(ShortenedUrl.SHORTENED_MAX_LENGTH)));
  ...
  private static Matcher<String> pointsTo(final String shortened) {
    // @formatter:off
